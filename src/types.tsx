...
export type SearchResult = {
    ...
    data?: Artist | Release | Song
}

export type Artist = {
    id: string // Unique identifier of the artist on the platform
    name: string // Name for the artist
    releases: string[] | Release[] // A string array containing platform unique identifiers to releases that fall under this artist
    image?: string
    songs?: string[] | Song[] // A string array containing platform unique identifiers to songs that fall under this artist
